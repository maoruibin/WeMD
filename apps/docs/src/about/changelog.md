...
* **Vue 致敬主题**：新增 **"Vue 官方绿"** 主题，完美复刻 Vue.js 官方文档的经典配色与清爽排版，致敬开源精神。
* **尾部模板增强**：
  * **全屏编辑体验**：尾部模板编辑面板升级为全局全屏模态框，提供沉浸式的大屏创作空间，告别狭窄的弹窗体验。
  * **Markdown 链接支持**：副标题与正文内容全面支持 Markdown 链接语法 `[文字](url)`，生成的链接自动适配微信样式，方便创作者在落款中添加个人主页或引流入口。

### 优化

* **默认主题调整**：默认主题回归经典的 **"极客橙 (Tech Orange)"**，保持高信噪比的阅读体验。
* **列表精简**：优化主题列表结构，移除重复选项，界面更清爽。
